...
class ReviewDataset(Dataset):
    def __init__(self, filepath, tokenizer):
        ...
        self.y = torch.tensor(self.data.rating) - 1
...
class ModelTrainer:
    ...
    def evaluate(self):
        ...
        acc = multiclass_accuracy(y_pred, y_test, num_classes=10, average=None)
        print('acc', acc)

        f1 = multiclass_f1_score(y_pred, y_test, num_classes=10, average=None)
        print('f1', f1)

        auc = multiclass_auroc(y_pred, y_test, num_classes=10, average=None)
        print('auc', auc)
    ...
    def train(self):
        ...
        for epoch in range(EPOCHS):
            ...
            if avg_vloss < best_vloss:
                ...
                model_path = 'multiclass_model_{}_{}'.format(timestamp, epoch_number)
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('multiclass_model_20240413_160238_6'))
